...
const teamDefinitions: TeamDefinition[] = [
  ...
  { key: "Brazil", displayName: "Brasil", flagCode: "br", aliases: ["brasil", "brasileira", "selecao brasileira", "seleção brasileira"] },
  ...
  { key: "England", displayName: "Inglaterra", flagCode: "gb-eng", aliases: ["inglaterra", "inglesa", "selecao inglesa", "seleção inglesa"] },
  { key: "France", displayName: "Franca", flagCode: "fr", aliases: ["franca", "francesa", "selecao francesa", "seleção francesa"] },
  { key: "Germany", displayName: "Alemanha", flagCode: "de", aliases: ["alemanha", "alema", "alemã", "selecao alema", "seleção alemã"] },
...
const spanishTeamDisplayNames: Record<string, string> = {
  Algeria: "Argelia",
  Belgium: "Belgica",
...
export function getTeamDisplayName(team: string, locale: AppLocale = "pt-BR") {
  ...
  if (locale === "es-ES") return definition.displayNames?.[locale] ?? spanishTeamDisplayNames[definition.key] ?? definition.displayName;
